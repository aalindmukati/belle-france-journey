...
const regions = [
  { name: "Île-de-France", image: ileImg, teaser: "The cultural and political heart of France, home to the dazzling city of Paris.", badge: "Most Visited" },
  { name: "Provence", image: provenceImg, teaser: "Sun-drenched lavender fields, olive groves, and charming hilltop villages along the Mediterranean.", badge: "Hidden Gem" },
  { name: "Brittany", image: brittanyImg, teaser: "A rugged, windswept peninsula with dramatic coastlines and an ancient Celtic heritage.", badge: "UNESCO Site" },
];
...
const Index = () => {
  return (
    <Layout>
      ...
      {/* Intro */}
      <section className="section-cream noise-texture py-20">
      ...
      {/* Featured Regions */}
      <section className="section-cream-light noise-texture py-20">
        <div className="container mx-auto px-6 relative z-10">
          <ScrollReveal>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-center mb-12 heading-reveal">Featured Regions</h2>
          </ScrollReveal>
      ...
      <section className="section-cream noise-texture py-20">
        <div className="container mx-auto px-6 max-w-4xl relative z-10">
          <ScrollReveal>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-center mb-4 heading-reveal">Explore by Region</h2>
            <p className="font-body text-center text-muted-foreground mb-12">Click a region to discover more</p>
          </ScrollReveal>
          <ScrollReveal>
            <FranceMapSVG />
          </ScrollReveal>
      ...
      <section className="section-cream-light noise-texture py-20">
        <div className="container mx-auto px-6 max-w-5xl relative z-10">
          <ScrollReveal>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-center mb-12 heading-reveal">France in Pictures</h2>
          </ScrollReveal>
          <PhotoGallery />
        </div>
      </section>
