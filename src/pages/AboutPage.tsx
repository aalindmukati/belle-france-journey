  ...
  <Layout>
    ...
    <section className="section-cream-light py-16">
      <div className="container mx-auto px-6 max-w-5xl">
        <ScrollReveal>
          <h2 className="font-display text-3xl font-bold text-center mb-12">Learning Outcomes</h2>
        </ScrollReveal>
        <div className="grid md:grid-cols-3 gap-8">
          {learningOutcomes.map((lo, i) => (
            <ScrollReveal key={lo.title} delay={i * 150}>
              <div className="bg-background rounded-xl shadow-md p-8 text-center h-full">
    ...
    <section className="section-cream py-16">
      <div className="container mx-auto px-6 max-w-4xl">
        <ScrollReveal>
          <h2 className="font-display text-3xl font-bold text-center mb-4">French Vocabulary Spotlight</h2>
